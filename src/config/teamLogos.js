...
const TEAM_ENTRIES = [
  ...
  { id: 'fenerbahce', name: 'Fenerbahçe', logo: '/teams/fenerbahce.png', aliases: ['fenerbahce', 'fenerbahçe', 'fener'] },
  ...
  { id: 'como', name: 'Como', logo: '/teams/como.png', aliases: ['como', 'como 1907'] },
